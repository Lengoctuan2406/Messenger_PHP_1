    ...
    <body>
        <div class="layout">
            ...
            <div class="sidebar">
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="hide-scrollbar">
                                <div class="container-fluid py-6">
                                    ...
                                    <!-- Title -->
                                    <h2 class="font-bold mb-6">Bạn bè</h2>
                                    <!-- Title -->
                                    ...
                                    <nav class="mb-n6">
                                        <?php
                                        //lấy ra thông tin tất cả bạn bè
                                        $query_friends_with = mysqli_query($con, "SELECT * FROM friends, accounts, status WHERE friends.account_friend_id=accounts.account_id AND accounts.status_id=status.status_id AND friends.account_id='" . $_SESSION['account_id'] . "'"
                                                . " ORDER BY account_name DESC;");
                                        while ($result = mysqli_fetch_array($query_friends_with)) {
                                            ?>
                                            <!-- Friend -->
                                            <div class="card mb-6">
                                                <div class="card-body">
                                                    <div class="media">
                                                        <?php if ($result['status_name'] == 'Đang online') { ?>
                                                            <div class="avatar avatar-online mr-5">
                                                            <?php } else { ?>
                                                                <div class="avatar mr-5">
                                                                <?php } ?>
                                                                <img class="avatar-img" src="assets\images\avatars\<?php echo $result['avatar']; ?>" alt="Anna Bridges">
                                                            </div>
                                                            <div class="media-body align-self-center">
                                                                <h6 class="mb-0"><?php echo $result['account_name']; ?></h6>
                                                                <small class="text-muted"><?php echo $result['status_name']; ?></small>
                                                            </div>
                                                            <div class="align-self-center ml-5">
                                                                <div class="dropdown z-index-max">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item d-flex align-items-center" href="index.php?account_friend_id=<?php echo $result['account_friend_id']; ?>">
                                                                            Trò chuyện <span class="ml-auto fe-edit-2"></span>
                                                                        </a>
                                                                        <a class="dropdown-item d-flex align-items-center" href="index.php?account_friend_id=<?php echo $result['account_friend_id']; ?>">
                                                                            Xóa <span class="ml-auto fe-trash-2"></span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="hide-scrollbar">
                                    <div class="container-fluid py-6">
                                        ...
                                        <!-- Title -->
                                        <h2 class="font-bold mb-6">Trò chuyện</h2>
                                        <!-- Title -->
                                        ...
                                        <div class="text-center hide-scrollbar d-flex my-7" data-horizontal-scroll="">
                                            <?php
                                            //lấy ra một số bạn bè đang online dạng ảnh online chung chung
                                            $query_friends_online = mysqli_query($con, "SELECT * FROM friends, accounts, chats, status WHERE friends.account_friend_id=accounts.account_id "
                                                    . "AND chats.account_id=friends.account_friend_id AND accounts.status_id=status.status_id AND friends.account_id='" . $_SESSION['account_id'] . "'"
                                                    . " ORDER BY accounts.status_id DESC;");
                                            while ($result = mysqli_fetch_array($query_friends_online)) {
                                                ?>
                                                <a href="index.php?name_chat_with=<?php echo $result['name_chat_with']; ?>" class="d-block text-reset mr-7 mr-lg-6">
                                                    <?php if ($result['status_name'] == 'Đang online') { ?>
                                                        <div class="avatar avatar-sm avatar-online mb-3">
                                                        <?php } else { ?>
                                                            <div class="avatar avatar-sm mb-3">
                                                            <?php } ?> 
                                                            <img class="avatar-img" src="assets\images\avatars\<?php echo $result['avatar'] ?>" alt="Image Description">
                                                        </div>
                                                        <div class="small"><?php echo substr($result['account_name'], 0, 10) . "..."; ?></div>
                                                </a>
                                            <?php } ?>
                                        </div>
                                        <!-- Favourites -->
                                        ...
                                        <nav class="nav d-block list-discussions-js mb-n6">
                                            <?php
                                            //lấy ra các cuộc trò chuyện đang có hiện tại
                                            $query_chats_with = mysqli_query($con, "SELECT * FROM chats WHERE account_id='" . $_SESSION['account_id'] . "';");
                                            while ($result = mysqli_fetch_array($query_chats_with)) {
                                                ?>
                                                <?php
                                                $query_chat = mysqli_query($con, "SELECT account_name, avatar, " . $result['name_chat_with'] . ".created_date, text, status_name FROM " . $result['name_chat_with'] . ", accounts, status WHERE " . $result['name_chat_with'] . ".account_id=accounts.account_id"
                                                        . " AND accounts.status_id=status.status_id ORDER BY created_date DESC LIMIT 1;");
                                                //in ra tin nhắn đầu tiên
                                                while ($result_chat_with = mysqli_fetch_array($query_chat)) {
                                                    $timestamp = strtotime($result_chat_with['created_date']);
                                                    ?>
                                                    <!-- Chat link -->
                                                    <a class="text-reset nav-link p-0 mb-6" href="index.php?name_chat_with=<?php echo $result['name_chat_with']; ?>">
                                                        <div class="card card-active-listener">
                                                            <div class="card-body">
                                                                <div class="media">
                                                                    <?php if ($result_chat_with['status_name'] == 'Đang online') { ?>
                                                                        <div class="avatar avatar-online mr-5">
                                                                        <?php } else { ?>
                                                                            <div class="avatar mr-5">
                                                                            <?php } ?> 
                                                                            <img class="avatar-img" src="assets\images\avatars\<?php echo $result_chat_with['avatar'] ?>" alt="Simon Hensley">
                                                                        </div>
                                                                        <div class="media-body overflow-hidden">
                                                                            <div class="d-flex align-items-center mb-1">
                                                                                <h6 class="text-truncate mb-0 mr-auto"><?php echo $result_chat_with['account_name'] ?></h6>
                                                                                <p class="small text-muted text-nowrap ml-4"><?php echo date("h:i", $timestamp) . " am"; ?></p>
                                                                            </div>
                                                                            <div class="text-truncate"><?php echo $result_chat_with['text'] ?></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="hide-scrollbar">
                                    <div class="container-fluid py-6">
                                        ...
                                        <!-- Title -->
                                        <?php
                                        //lấy ra thông tin cơ bản của tài khoản
                                        $query_user_detail = mysqli_query($con, "SELECT * FROM accounts WHERE account_id='" . $_SESSION['account_id'] . "';");
                                        while ($result = mysqli_fetch_array($query_user_detail)) {
                                            ?>
                                            <!-- Card -->
                                            <div class="card mb-6">
                                                <div class="card-body">
                ...
                <?php
                //tạo session để hiển thị trang nhập tin nhắn
                if (!isset($_SESSION['name_chat_with'])) {
                    ?>
                    <!-- Main Content -->
