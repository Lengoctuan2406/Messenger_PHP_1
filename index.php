                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="hide-scrollbar">
                                <div class="container-fluid py-6">
                                    ...
                                    <nav class="mb-n6">
                                        <?php
                                        while ($result = mysqli_fetch_array($query_friends)) {
                                            ?>
                                            ...
                                            <?php if ($result['status_id'] == 1) { ?>
                                                ...
                                                <div class="card mb-6">
                                                    <div class="card-body">
                                                        <div class="media">
                                                            <div class="avatar mr-5">
                                                                <img class="avatar-img" src="assets\images\avatars\<?php echo $result['avatar']; ?>" alt="Zane Mayes">
                                                            </div>
                                                            <div class="media-body align-self-center">
                                                                <h6 class="mb-0"><?php echo $result['account_name']; ?></h6>
                                                                <small class="text-muted"><?php echo $result['status_name']; ?></small>
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="hide-scrollbar">
                                <div class="container-fluid py-6">
                                    ...
                                    <!-- Title -->
                                    <h2 class="font-bold mb-6">Trờ chuyện</h2>
                                    <!-- Title -->
                                    ...
                                    <nav class="nav d-block list-discussions-js mb-n6">
                                        <?php
                                        //in ra các cuộc trò chuyện
                                        while ($result = mysqli_fetch_array($query_chats)) {
                                            ?>
                                            <?php
                                            $query_chat = mysqli_query($con, "SELECT account_name, avatar, " . $result['name_chat_with'] . ".created_date, text, status_id FROM " . $result['name_chat_with'] . ", accounts WHERE " . $result['name_chat_with'] . ".account_id=accounts.account_id"
                                            ...
                                            while ($result_chat_with = mysqli_fetch_array($query_chat)) {
                                                ...
                                                <a class="text-reset nav-link p-0 mb-6" href="index.php?name_chat_with=<?php echo $result['name_chat_with'];?>">
                                                    <div class="card card-active-listener">
                                                        <div class="card-body">
                                                            <div class="media">
                                                                <?php if ($result_chat_with['status_id'] == 1) { ?>
                                                                    <div class="avatar mr-5">
                                                                    <?php } else { ?>
                                                                        <div class="avatar avatar-online mr-5">
                                                                        <?php } ?> 
